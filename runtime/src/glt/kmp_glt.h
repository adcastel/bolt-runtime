...
#elif KMP_USE_GLT
typedef GLT_ult          kmp_thread_t;
typedef GLT_tasklet            kmp_tasklet_t;
typedef GLT_key             kmp_key_t;
typedef GLT_barrier         kmp_barrier_t;
typedef GLT_mutex           kmp_mutex_t;
typedef GLT_cond            kmp_cond_t;
typedef GLT_mutex           kmp_lock_t;
typedef GLT_mutex           kmp_bootstrap_lock_t;
// [AC]
typedef GLT_ult            kmp_abt_task_t;
#else
...
#elif KMP_USE_GLT
#define __kmp_mutex_lock(m)                             glt_mutex_lock(m)
#define __kmp_mutex_trylock(m)                          glt_mutex_trylock(m)
#define __kmp_mutex_unlock(m)                           glt_mutex_unlock(m)

#define __kmp_init_lock(l_ptr)                          glt_mutex_create(l_ptr)
#define __kmp_destroy_lock(l_ptr)                       glt_mutex_free(l_ptr)
#define __kmp_acquire_lock(l_ptr,gtid)                  glt_mutex_lock(*(l_ptr))
#define __kmp_test_lock(l_ptr,gtid)                     glt_mutex_trylock(*(l_ptr))
#define __kmp_release_lock(l_ptr,gtid)                  glt_mutex_unlock(*(l_ptr))

#define __kmp_init_bootstrap_lock(l_ptr)                glt_mutex_create(l_ptr)
#define __kmp_destroy_bootstrap_lock(l_ptr)             glt_mutex_free(l_ptr)
#define __kmp_acquire_bootstrap_lock(l_ptr)             glt_mutex_lock(*(l_ptr))
#define __kmp_test_bootstrap_lock(l_ptr)                glt_mutex_trylock(*(l_ptr))
#define __kmp_release_bootstrap_lock(l_ptr)             glt_mutex_unlock(*(l_ptr))

#define __kmp_init_queuing_lock(l_ptr)                  glt_mutex_create(l_ptr)
#define __kmp_destroy_queuing_lock(l_ptr)               glt_mutex_free(l_ptr)
#define __kmp_acquire_queuing_lock(l_ptr,gtid)          glt_mutex_lock(*(l_ptr))
#define __kmp_test_queuing_lock(l_ptr,gtid)             glt_mutex_trylock(*(l_ptr))
#define __kmp_release_queuing_lock(l_ptr,gtid)          glt_mutex_unlock(*(l_ptr))

#define __kmp_init_tas_lock(l_ptr)                      glt_mutex_create(l_ptr)
#define __kmp_destroy_tas_lock(l_ptr)                   glt_mutex_free(l_ptr)
#define __kmp_acquire_tas_lock(l_ptr,gtid)              glt_mutex_lock(*(l_ptr))
#define __kmp_test_tas_lock(l_ptr,gtid)                 glt_mutex_trylock(*(l_ptr))
#define __kmp_release_tas_lock(l_ptr,gtid)              glt_mutex_unlock(*(l_ptr))
...
#if defined(KMP_ABT_USE_TASKLET_TEAM) || defined(KMP_GLT_USE_TASKLET_TEAM)
