...
# Check if GLT support is available
if(${LIBOMP_USE_GLT})
  if(WIN32)
    set(LIBOMP_HAVE_GLT FALSE)
    libomp_say("Using GLT not supported on Windows yet")
  else()
    set(CMAKE_REQUIRED_INCLUDES ${LIBOMP_GLT_INSTALL_DIR} ${LIBOMP_GLT_UNDER_LIB_INC})
    #set(CMAKE_REQUIRED_INCLUDES ${LIBOMP_GLT_INSTALL_DIR})
    check_include_file(glt.h LIBOMP_HAVE_GLT_H)
    set(CMAKE_REQUIRED_INCLUDES)
    check_library_exists(glt glt_init ${LIBOMP_GLT_INSTALL_DIR} LIBOMP_HAVE_LIBGLT)
    find_library(LIBOMP_GLT_LIBRARY glt ${LIBOMP_GLT_INSTALL_DIR})
    get_filename_component(LIBOMP_GLT_LIBRARY_DIR ${LIBOMP_GLT_LIBRARY} PATH)
    if(LIBOMP_HAVE_GLT_H AND LIBOMP_HAVE_LIBGLT AND LIBOMP_GLT_LIBRARY)
      set(LIBOMP_HAVE_GLT TRUE)
    else()
      set(LIBOMP_HAVE_GLT FALSE)
      libomp_say("Could not find GLT")
    endif()
  endif()
endif()
