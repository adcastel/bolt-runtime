...
if(WIN32)
  ...
  libomp_append(libomp_test_touch_libs "${LIBOMP_GLT_LIBRARY}" LIBOMP_USE_GLT)
  if(APPLE)
    ...
    libomp_append(libomp_test_touch_ldflags "-Wl,-rpath,${LIBOMP_GLT_LIBRARY_DIR}" LIBOMP_USE_GLT)
  else()
...
if(CMAKE_SYSTEM_NAME MATCHES "FreeBSD")
  ...
  libomp_append(libomp_expected_library_deps libglt.so LIBOMP_USE_GLT)
